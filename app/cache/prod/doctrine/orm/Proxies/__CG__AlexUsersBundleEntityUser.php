...
namespace Proxies\__CG__\Alex\UsersBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Alex\UsersBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Alex\\UsersBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Alex\\UsersBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'Alex\\UsersBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Alex\\UsersBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'Alex\\UsersBundle\\Entity\\User' . "\0" . 'is_admin', '' . "\0" . 'Alex\\UsersBundle\\Entity\\User' . "\0" . 'created_at', '' . "\0" . 'Alex\\UsersBundle\\Entity\\User' . "\0" . 'updated_at');
        }
     ...
     * {@inheritDoc}
     */
    public function equals(\Alex\UsersBundle\Entity\User $user)
    {
